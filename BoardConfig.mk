...
# Kernel
#TARGET_PREBUILT_KERNEL := device/lenovo/aio_row/configs/kernel
ifeq ($(TARGET_PREBUILT_KERNEL),)
BOARD_KERNEL_IMAGE_NAME := Image.gz
TARGET_KERNEL_CONFIG := aio_row_o_defconfig
...
TARGET_OTA_ASSERT_DEVICE := A7000-a,aio_row,aio_row,A7000-a
TARGET_CUSTOM_BINARY := device/lenovo/aio_row/configs/updater
